...
namespace AOWH.Infrastructure.Migrations
{
    ...
    [Migration("20230507155126_initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Accounting", b =>
                {
                    ...
                    b.Property<decimal>("Mentoring")
                        .HasPrecision(10, 2)
                        .HasColumnType("numeric(10,2)")
                        .HasColumnName("mentoring");

                    b.Property<int>("OvertimeDay")
                        .HasColumnType("integer")
                        .HasColumnName("overtime_day");

                    b.Property<int>("OvertimeNight")
                        .HasColumnType("integer")
                    ...
                    b.Property<decimal>("SalaryForHour")
                        .HasPrecision(10, 2)
                        .HasColumnType("numeric(10,2)")
                        .HasColumnName("salary_for_hour");

                    b.Property<decimal>("SalaryForShift")
                        .HasPrecision(10, 2)
                        .HasColumnType("numeric(10,2)")
                        .HasColumnName("salary_for_shift");

                    b.Property<decimal>("Sends")
                        .HasPrecision(10, 2)
                        .HasColumnType("numeric(10,2)")
                        .HasColumnName("sends");
            ...
            modelBuilder.Entity("AccountingHistory", b =>
                {
                    b.Property<Guid>("AccountingHistoryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<decimal>("AdvancePrev")
                        .HasColumnType("numeric")
                    ...
                    b.Property<decimal>("MentoringPrev")
                        .HasColumnType("numeric")
                    ...
                    b.Property<decimal>("TeachingPrev")
                        .HasColumnType("numeric")
                    ...
                    b.Property<decimal>("VacationPrev")
                        .HasColumnType("numeric")
                    ...
                    b.HasKey("AccountingHistoryId");

                    b.HasIndex("EmployeeId");

                    b.ToTable("accounting_history", (string)null);
                });
            ...
            modelBuilder.Entity("Shift", b =>
                {
                    b.HasOne("Employee", "EmployeeWhoPostedTheShift")
                        .WithMany("Shifts")
